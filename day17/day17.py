'''Aoc Day17 Both parts
move the lava with minimum heat loss
*** I cheated again*** this solution is mostly from:
https://github.com/fuglede/adventofcode/blob/master/2023/day17/solutions.py
You can see my attemps in the other files'''
